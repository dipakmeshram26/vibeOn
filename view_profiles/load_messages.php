...
while ($row = $result->fetch_assoc()) {
    if ($row['sender_id'] == $current_user_id) {
        echo "<div style='text-align:right; color:blue;'>" . htmlspecialchars($row['message']) . "</div>";
    } else {
        echo "<div style='text-align:left; color:green;'>" . htmlspecialchars($row['message']) . "</div>";
    }
}
?>
